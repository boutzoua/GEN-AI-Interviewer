...
def load_lottiefile(filepath: str):
    with open(filepath, "r") as f:
        return json.load(f)
st_lottie(load_lottiefile("images/talk.json"), speed=1, reverse=False, loop=True, quality="high", height=300)
...
st.markdown("""\n""")
position = st.selectbox("Select the position you are applying for", ["Data Scientist","Data Analyst","Software Engineer","Salesforce Administrator","Marketing"])
